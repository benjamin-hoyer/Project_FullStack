...
export const webRoutes = [
  { method: "GET", path: "/", config: accountsController.index },
  {
    method: "GET",
    path: "/signup",
    config: accountsController.showSignup,
  },
  { method: "GET", path: "/login", config: accountsController.showLogin },
  {
    method: "GET",
    path: "/logout",
    config: accountsController.logout,
  },
  ...
  },
  {
    method: "GET",
    path: "/category/{id}",
    config: categoriesController.index,
  },
  {
    method: "POST",
  ...
  { method: "GET", path: "/admin", config: adminController.showAdmin },
  {
    method: "POST",
    path: "/admin/adduser",
    config: adminController.addUser,
  },
  {
    method: "GET",
  ...
  {
    method: "GET",
    path: "/category/{id}/hike/{hikeid}",
    config: hikeController.index,
  },
  {
    method: "POST",
    path: "/category/{id}/updatehike/{hikeid}",
